...
when      ODIN_OS == .Windows do foreign import lib "../imgui/imgui_windows_x64.lib"
else when ODIN_OS == .Linux   do foreign import lib "./imgui/imgui_linux_x64.a"
else when ODIN_OS == .Darwin {
	when ODIN_ARCH == .amd64 { foreign import lib "./imgui/imgui_darwin_x64.a" } else { foreign import lib "./imgui/imgui_darwin_arm64.a" }
}
